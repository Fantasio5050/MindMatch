...
export const RUSSIAN_ROULETTE_GAGES: string[] = [
  ...
  'Enlève un vêtement de ton choix pour le reste de la partie.',
  'Décris ton dernier rapport en détail… ou double cul sec.',
  'Laisse la table lire tes 3 derniers messages envoyés à ton crush.',
  'Avoue ton fantasme le plus honteux, à voix haute. Sinon, cul sec triple.',
  'Simule un orgasme bruyant devant toute la table, 10 secondes.',
  'Montre ta recherche la plus récente en navigation privée (ou finis ton verre cul sec).',
  'Envoie « je pense à toi, là, tout de suite » à un contact au pif.',
  'Fais un lap dance de 15 secondes à la personne en face (ou cul sec).',
  'Fais deviner un mot cochon uniquement en mimant — 30 secondes.',
  'Dis quel·le joueur·se de la table te fait le plus d\'effet. Sans mentir.',
]
