...
// avait remplacés par des cartes « simulées » (sic). Les cartes pc-40 à pc-50 sont des ajouts
// ultérieurs, conservés après relecture.
export const classicPartyCards: PartyCard[] = [
  ...
  { id: 'pc-42', pack: 'classic', type: 'defi', text: 'Fais 5 squats en chantant un jingle publicitaire' },
  ...
  { id: 'pc-45', pack: 'classic', type: 'defi', text: 'Essaie de faire un cœur avec tes mains et tes doigts' },
  { id: 'pc-46', pack: 'classic', type: 'action', text: 'Fais croire que tu es un influenceur testant un produit totalement inutile' },
  { id: 'pc-47', pack: 'classic', type: 'verite', text: 'Quelle est la pire excuse que tu aies donnée pour annuler un plan ?' },
  { id: 'pc-48', pack: 'classic', type: 'defi', text: 'Marche comme un mannequin sur un podium imaginaire pendant 10 sec' },
...
export const spicyPartyCards: PartyCard[] = [
  { id: 'ps-1', pack: 'spicy', type: 'action', text: 'Donne un bisou dans le cou de quelqu\'un qui est d\'accord' },
  { id: 'ps-2', pack: 'spicy', type: 'verite', text: 'Quel est ton fantasme le plus soft que tu n\'as jamais réalisé ?' },
  { id: 'ps-3', pack: 'spicy', type: 'defi', text: 'Danse lentement avec quelqu\'un du même sexe pendant 20 secondes' },
  ...
  { id: 'ps-6', pack: 'spicy', type: 'defi', text: 'Fais un massage des mains de 30 secondes à quelqu\'un' },
  { id: 'ps-7', pack: 'spicy', type: 'action', text: 'Regarde quelqu\'un dans les yeux pendant 15 secondes sans rien dire' },
  { id: 'ps-8', pack: 'spicy', type: 'verite', text: 'As-tu déjà eu un crush sur quelqu\'un de ce groupe sans jamais rien dire ?' },
  { id: 'ps-9', pack: 'spicy', type: 'defi', text: 'Essaie de faire rougir quelqu\'un avec un compliment en 10 secondes' },
  ...
  { id: 'ps-12', pack: 'spicy', type: 'defi', text: 'Marche comme un mannequin en mettant en valeur tes meilleurs atouts' },
  { id: 'ps-13', pack: 'spicy', type: 'action', text: 'Échange tes places avec quelqu\'un et reste collé·e à lui ou elle pendant 1 minute' },
  { id: 'ps-14', pack: 'spicy', type: 'verite', text: 'À quel âge as-tu eu ton premier baiser et comment c\'était ?' },
  { id: 'ps-15', pack: 'spicy', type: 'defi', text: 'Marche au ralenti pendant 10 secondes, comme dans un film romantique' },
  { id: 'ps-16', pack: 'spicy', type: 'action', text: 'Invite quelqu\'un à danser un slow de 10 secondes' },
  { id: 'ps-17', pack: 'spicy', type: 'verite', text: 'Qu\'est-ce qui te fait immédiatement craquer chez quelqu\'un ?' },
  { id: 'ps-18', pack: 'spicy', type: 'defi', text: 'Essaie de ne pas sourire alors que quelqu\'un te dit quelque chose de mignon' },
  { id: 'ps-19', pack: 'spicy', type: 'action', text: 'Fais croire que tu es timide alors que tu ne l\'es pas du tout' },
  { id: 'ps-20', pack: 'spicy', type: 'verite', text: 'As-tu déjà menti sur ton nombre de partenaires pour paraître plus ou moins expérimenté·e ?' },
  { id: 'ps-21', pack: 'spicy', type: 'defi', text: 'Fais un clin d\'œil suggestif suivi d\'un sourire en coin' },
  ...
  { id: 'ps-24', pack: 'spicy', type: 'defi', text: 'Danse comme si tu étais dans un clip vidéo de R&B soft' },
  ...
  { id: 'ps-27', pack: 'spicy', type: 'defi', text: 'Marche lentement en roulant exagérément des hanches' },
  ...
  { id: 'ps-30', pack: 'spicy', type: 'defi', text: 'Joue l\'hypersensible au moindre effleurement pendant 20 secondes' },
]

export const allPartyCards: PartyCard[] = [...classicPartyCards, ...trashPartyCards, ...spicyPartyCards]
